...
dishRouter.route('/:dishId')
    .get(authenticate.verifyOrdinaryUser, authenticate.verifyUser, (req, res, next) => {
...
dishRouter.route('/:dishId/comments')
    ...
    .post(authenticate.verifyOrdinaryUser, authenticate.verifyUser, (req, res, next) => {
        Dishes.findById(req.params.dishId)
            .then((dish) => {
                if (dish != null) {
    ...
    .put(authenticate.verifyOrdinaryUser, authenticate.verifyUser, (req, res, next) => {
        res.statusCode = 403;
