...
dishRouter.route('/:dishId')
    ...
    .get(cors.cors, authenticate.verifyOrdinaryUser, authenticate.verifyUser, (req, res, next) => {
...
dishRouter.route('/:dishId/comments')
    ...
    .post(cors.corsWithOptions, authenticate.verifyOrdinaryUser, authenticate.verifyUser, (req, res, next) => {
        Dishes.findById(req.params.dishId)
            .then((dish) => {
                if (dish != null) {
